...
import { setLLMProviderHandler, setKGProviderHandler, getKGProviderHandler, ollamaStatusHandler } from './handlers/settings.js';
...
// - 8080: 常见开发端口
const ALLOWED_DEV_PORTS = new Set(['5173', '4173', '3000', '8080']);
